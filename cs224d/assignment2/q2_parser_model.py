...
class ParserModel(Model):
    ...
    def add_placeholders(self):
        ...
        self.labels_placeholder = tf.placeholder(tf.float32,shape=[None, self.config.n_classes], name="labelsr")
    ...
    def add_loss_op(self, pred):
        ...
        loss = tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(logits=pred, labels=self.labels_placeholder) + self.l2_loss)
